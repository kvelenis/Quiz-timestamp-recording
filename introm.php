...
<audio id="myAudio1">
  <source src="assets/mp3sm/Piano_Sonata_No11_in_A_major-K331W_A_Mozartm.mp3" type="audio/mp3">
</audio>


<script>

var beatTimeChange_intro_midi = [];	
...
document.addEventListener("keydown", getCurTime = function() {
      ...
      beatTimeChange_intro_midi.push(aud1.currentTime);
  });
  ...
  //sendArray();
          ...
          if (result.isConfirmed) {
			...
			//window.location.href='includes/receiveintro.php';
           	//sendArray(c);
...
$.ajax({
url     : 'includes/receiveintrom.php',
method    : 'POST',
data :{
  data:c,
  arrayData:beatTimeChange_intro_midi
},
