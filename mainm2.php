...
<audio id="myAudio1">
  <source src="assets/mp3sm/chilly_gonzales-_gogolm.mp3" type="audio/mp3">
</audio>
...
$.ajax({
url     : 'includes/receivedatamain_2_1.php',
method    : 'POST',
data :{
  data:c,
 arrayData5:beatTimeChange1
},
...
$.ajax({
url     : 'includes/receivedatamain_2_2.php',
method    : 'POST',
data :{
 arrayData6:beatTimeChange2
},
success   : function(response)
{
//alert("data sent response is "+response);
...
$.ajax({
url     : 'includes/receivedatamain_2_3.php',
method    : 'POST',
data :{
 arrayData7:beatTimeChange3
},
success   : function(response)
{
//alert("data sent response is "+response);
...
$.ajax({
url     : 'includes/receivedatamain_2_4.php',
method    : 'POST',
data :{
 arrayData8:beatTimeChange4
},
success   : function(response)
{
...
//alert(response);
if (response == "mainm3") {
	window.location.replace("mainm3.php?userinput=success");
}

else if (response == "mainm") {
