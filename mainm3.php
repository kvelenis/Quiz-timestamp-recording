...
<!--	<h2>Τα παρακάτω κουμπάκια είναι βοηθητικά για να τρέξετε το τεστ στα γρήγορα να δείτε πως λειτουργεί, τα πατάτε και πηγαίνει στο τέλος το απόσπασμα, δεν θα φαίνονται στην πραγματική έκδοση, πατήστε τα απλά αφού πατήσετε το play button κάθε φορά γιατί αλλιώς θα γίνει μακελειό</h2>-->
...
<audio id="myAudio1">
  <source src="assets/mp3sm/A_Schoenberg_-_i_3_pieces_Op11m.mp3" type="audio/mp3">
</audio>
...
$.ajax({
url     : 'includes/receivedatamain_3_1.php',
method    : 'POST',
data :{
  data:c,
 arrayData9:beatTimeChange1
},
...
$.ajax({
url     : 'includes/receivedatamain_3_2.php',
method    : 'POST',
data :{
 arrayData10:beatTimeChange2
},
success   : function(response)
{
//alert("data sent response is "+response);
...
$.ajax({
url     : 'includes/receivedatamain_3_3.php',
method    : 'POST',
data :{
 arrayData11:beatTimeChange3
},
success   : function(response)
{
//alert("data sent response is "+response);
...
$.ajax({
url     : 'includes/receivedatamain_3_4.php',
method    : 'POST',
data :{
 arrayData12:beatTimeChange4
},
success   : function(response)
{
...
if (response == "mainm") {
	window.location.replace("mainm.php?userinput=success");
}

else if (response == "mainm2") {
	window.location.replace("mainm2.php?userinput=success");
}
