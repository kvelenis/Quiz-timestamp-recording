...
<form id="theForm" action="includes/userinput.inc.php" method="POST">
  ...
  <select name="age">
    ...
    <option value="65">55 - 65</option>
    <option value="75">65 - 75</option>
    <option value="85">75 - 85</option>
  </select>
  <br>
  ...
  <select name="gender" data-placeholder="Gender">
    <option value="" disabled selected hidden>Sex assigned at birth</option>
  ...
  <select name="musicPreferences" data-placeholder="musicPreferences">
    <option value="" disabled selected hidden>Music Preferences</option>
